...
public class StudentMapper {
    ...
    public Student mapStudentToDomainEntity(StudentJDBCEntity entity) {
        Student student = createStudentWithId(
                StudentId.of(entity.studentId()),
                StudentUserId.of(entity.studentUserId()),
    ...
    public StudentJDBCEntity mapStudentToJDBCEntity(Student student) {
        return new StudentJDBCEntity(
                student.getStudentId(),
                student.getStudentUserId(),
                student.getFirstName(),
                student.getLastName(),
                courseMapper.mapCoursesToJDBCEntities(student.getCourses()),

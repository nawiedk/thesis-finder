...
public class TopicController {
    ...
    @ResponseBody
    public boolean deleteTopic(@PathVariable("id") Long supervisorId, RedirectAttributes redirectAttributes){
        return topicDeleteUseCase.deleteTopic(new TopicDeleteCommand(supervisorId));
    }

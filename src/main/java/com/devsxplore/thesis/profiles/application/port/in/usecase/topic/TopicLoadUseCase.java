...
import com.devsxplore.thesis.profiles.application.port.in.command.topic.LoadSingleTopicCommand;
...
public interface TopicLoadUseCase {
    ...
    Topic loadSingleTopicById(LoadSingleTopicCommand command);
}
